...
import { SCHOOL_LIST, REFERRALS_INFO, SCHOOL_INFO, ADD_USERS, AddUserAction, GET_MIS_FACULTY } from 'actions/index'
		...
		case SCHOOL_INFO:
		{
			return {
				...
				school_Info: {
					...
					tip_pilot: (action as SchoolInfoAction).tip_pilot
				}
			}
		}
