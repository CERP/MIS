...
const IlmExchangeAnalytics: React.FC<PropsType> = ({ students, events, lessons, fetchLessons, classes }) => {
	...
	return (
		<div className="ilmx-analytics section-container">
			...
			<div className="text-left heading" style={{ marginTop: 4, fontWeight: 700, marginBottom: "1rem", fontSize: "1.25rem" }}>Most viewed videos</div>
			<div className="section">
				...
				{toggleCalendar && <div className="calender">
					<input type="date" name="lesson_videos"
				...
				<div className="container">
					...
					{
						stateProps.showViewerModal && lessons_data && <Modal>
							<LessonViewerModal
