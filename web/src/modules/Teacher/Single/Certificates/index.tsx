		...
		return (
			<div className="certificate mx-auto">
				...
				<div className="cert-Info no-print">
					...
					<div className="button blue" onClick={() => window.print()}>
						Print
					</div>
				</div>
			...
			<div className="body">
				<div className="para" contentEditable={true}>
					...
					<span className="emphasize">
						{curr_teacher.ManName ? curr_teacher.ManName : '________________'}
					</span>
					, has worked as a teacher of the following subjects in our school from{' '}
					<b style={{ textDecoration: 'underline' }}>{`${moment(
						curr_teacher.HireDate
					).format('DD-MM-YYYY')} `}</b>
					to{' '}
				...
				<div className="para" contentEditable={true}>
					...
					and hardworking during {getGenderSpecificText('his/her', gender)} tenure.{' '}
					{capitalize(getGenderSpecificText('he/she', gender))} can prove to be an asset
					for any organization. We wish {getGenderSpecificText('him/her', gender)} success
					in {`${getGenderSpecificText('his/her', gender)} `}
					future endeavours.
				</div>
			</div>
		...
		<div className="certificate-page">
			...
			<div className="body">
				<div className="para" contentEditable={true}>
					...
					<span className="emphasize">{curr_teacher.Name}</span>,
					{` ${getGenderSpecificText('son/daughter', gender)}`} of{' '}
					<span className="emphasize">
						{curr_teacher.ManName ? curr_teacher.ManName : '________________'}
					</span>{' '}
					to acknowledge {`${getGenderSpecificText('his/her', gender)} `}
					outstanding performance in his work as the teacher of the following subjects in
					our school.
				</div>
				...
				<div className="para" contentEditable={true}>
					...
					up this good work during {getGenderSpecificText('his/her', gender)} tenure.
				</div>
			</div>
