...
const Home: React.FC<PropsType> = (props) => {
    ...
    return <div className="flex flex-wrap content-between bg-white">
        ...
        <Link className="container sm:px-8 bg-white rounded-2xl m-3 h-44 flex flex-col content-center items-center shadow-lg"
        ...
        <Link className="container sm:px-8 bg-white rounded-xl m-3 h-28 flex flex-row content-between items-center shadow-lg"
        ...
        <div className="flex flex-row content-center items-center justify-center w-full">
            <Link className="container sm:px-8 bg-white rounded-xl m-3 h-40 flex flex-col content-center items-center shadow-lg"
