	...
	return (
		<div className="flex flex-wrap content-between bg-white mt-20">
			...
			<div className="flex flex-row justify-center items-center w-full mt-4">
				<div className="flex flex-row justify-center items-center w-full">
					...
					<Link
						...
						<div className="text-xs text-blue-900 font-bold sm:text-md">Results</div>
					</Link>
				</div>
			</div>
			...
			<div className="w-full flex justify-center m-3">
				<Link
					className="w-full bg-white rounded-2xl h-44 flex flex-col justify-center items-center border border-gray-100 shadow-md no-underline"
					to={'/targeted-instruction/ht-dashboard'}>
					<img className="h-24 w-28" src={HtIcon} alt="img" />
					<div className="text-xs text-blue-900 font-bold sm:text-md">
			...
			{false && layout === Layouts.DIAGNOSTIC && (
				<div className="flex flex-row justify-center items-center w-full opacity-50">
					<div className="flex flex-row justify-center items-center w-full md:w-full lg:w-11/12 2xl:w-8/12">
						<Link
							className="container sm:px-8 bg-white rounded-xl m-3 h-28 flex flex-col justify-center items-center border border-gray-100 shadow-md no-underline"
							to={'/targeted-instruction/formative-test'}>
							<img className="h-12 p-4" src={Formative} alt="img" />
							<div className="text-xs text-blue-900 font-bold text-center sm:text-md">
								Midpoint Test
							</div>
						</Link>
						<Link
