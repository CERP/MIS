...
const Home: React.FC<PropsType> = (props) => {
    ...
    return <div className="flex flex-wrap content-between">
        ...
        <div className="w-full">
            <div className="text-blue-900 text-lg font-medium text-center">Welcome to TIP</div>
            <div className="text-blue-900 text-sm font-thin text-center">What would you like to do today ?</div>
        </div>
        <Link className="container sm:px-8 bg-white rounded-lg m-3 h-36 flex flex-col content-between shadow-lg" to={'/targeted-instruction/formative-test'}>
        ...
        <Link className="container sm:px-8 bg-white rounded-lg m-3 h-20 flex flex-row content-between shadow-lg" to={"/targeted-instruction/diagnostic-result"}>
        ...
        <div className="flex flex-row content-between w-full">
            <Link className="container w-1/2 sm:px-8 bg-white rounded-lg m-3 h-36 flex flex-col content-between shadow-lg" to={"/targeted-instruction/training-videos"}>
            ...
            <Link className="container w-1/2 sm:px-8 bg-white rounded-lg m-3 h-36 flex flex-col content-between shadow-lg" to={"/targeted-instruction/lesson-plans"}>
