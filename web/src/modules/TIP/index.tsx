...
const Home: React.FC<PropsType> = ({ faculty, faculty_id }) => {
	...
	return (
		<div className="flex flex-wrap content-between bg-white mt-20">
			...
			{
				<Link
					className={`flex justify-center content-center w-full my-2 no-underline`}
			...
			{layout === Layouts.DIAGNOSTIC && (
				<div className="w-full flex justify-center mx-3">
					<Link
						className="w-full bg-white rounded-2xl h-44 flex flex-col content-center items-center shadow-lg no-underline"
			...
			<div className="flex flex-row content-center items-center justify-center w-full mt-4">
				<div className="flex flex-row content-center items-center w-full">
					<Link
						className="container sm:px-8 bg-white rounded-xl m-3 h-36 flex flex-col content-center items-center shadow-lg space-y-2"
