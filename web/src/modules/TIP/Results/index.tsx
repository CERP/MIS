	...
	return (
		<div className="bg-white flex flex-wrap content-between mt-20">
			...
			<div className="flex flex-row justify-around w-full mt-5 p-3 space-x-2">
				<Link
					className="text-center bg-white px-2 rounded-lg h-48 w-48 flex flex-col justify-center items-center shadow-lg no-underline space-y-2"
			...
			<div className="w-full px-4 py-5">
				<Link
					className="bg-gray-tip opacity-100 rounded-lg flex flex-row justify-around items-center w-full no-underline shadow-lg py-4"
