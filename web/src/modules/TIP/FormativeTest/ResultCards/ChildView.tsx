...
const ChildView: React.FC<P> = ({ name, score, percentage, setType }) => {
    ...
    return <div className={`${percentage < 33 ? "bg-red-primary text-white" : "bg-blue-200 text-blue-900"} flex flex-row justify-between items-center px-3 my-2 h-11 shadow-lg w-full`} onClick={() => setType('single_std_view')}>
