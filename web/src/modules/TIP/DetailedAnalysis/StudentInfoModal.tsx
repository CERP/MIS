            ...
            </div>
            {
                Object.entries(learning_levels || {})
                    .map(([sub, grade_obj]) => {
                        ...
                        return <div key={grade} className="mb-3 h-12 md:h-16 text-sm md:text-base bg-white flex flex-row justify-around items-center cursor-pointer font-bold text-blue-900 shadow-lg">
