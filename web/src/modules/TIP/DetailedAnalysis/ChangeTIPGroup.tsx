        ...
        <div className="flex flex-col rounded-t-xl padding-3 bg-white">
            ...
            ${current_group} to ${new_group}`} />
                <div className="flex flex-row justify-around items-center mt-5">
                    <div className={clsx("text-center py-2 px-1 md:py-3 md:px-2 lg:py-3 lg:px-4 rounded-md text-white text-sm md:text-base lg:text-lg mr-1", {
                ...
                To
                    <div className={clsx("text-center py-2 px-1 md:py-3 md:px-2 lg:py-3 lg:px-4 rounded-md text-white text-sm md:text-base lg:text-lg ml-1", {
                        "bg-gray-400": new_group === 'Oral',
                        "bg-gray-600": new_group === 'Remediation Not Needed'
                    }, `bg-${new_group.toLowerCase()}-tip-brand`)}>{new_group === 'Remediation Not Needed' ? new_group : `${new_group} Group`}</div>
                </div>
