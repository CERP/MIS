...
const Classes: React.FC<PropsType> = () => {

    return <div className="flex flex-wrap flex-row justify-around w-full mx-4">
        {classes.map((classObj) => (
            <div key={classObj.class} className="flex-wrap container w-2/5 sm:px-8 bg-white rounded-lg m-3 h-28 flex items-center justify-start flex-col shadow-lg">
