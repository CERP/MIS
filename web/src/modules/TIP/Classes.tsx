    ...
    return <div className="flex flex-wrap flex-row justify-around w-full mx-4">
        {
            sortedSections.map((classObj, index) => (<div
                ...
                <div className={`text-white font-bold shadow-2xl flex items-center justify-center mt-8 mb-5 rounded-full text-xl h-12 w-12 ${index === 0 ?
                    "bg-blue-primary" :
                    index === 1 ? "bg-orange-primary" :
                        index === 2 ? "bg-green-primary" :
                            index === 3 ? "bg-blue-900" :
                                "bg-red-primary"}`}>{(classObj.namespaced_name).substring(6)}</div>
