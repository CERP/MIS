...
class StudentExcelImport extends React.Component<P, S> {
		...
		reader.onloadend = () => {
			...
			const malformedData = importedStudents.find(s => {
				const matchingAdmission =
					s.AdmissionNumber &&
					Object.values(this.props.students).find(
						existing =>
							existing.AdmissionNumber &&
							existing.AdmissionNumber === s.AdmissionNumber
					)
	...
	onSave = () => {
		...
		const [class_id] = Object.entries(this.props.classes || {}).find(([, meta]) =>
				...
				<div className="section-container excel-import-students" style={{ marginTop: 10 }}>
					...
					<div className="row" style={{ justifyContent: 'flex-end' }}>
						<div
							...
							style={{ display: 'flex' }}
							onClick={this.onStudentImportTemplateClick}>
							<img
								width={20}
								height={20}
							...
							<div className="file-upload-container">
								<label className="file-upload">
									<input
										...
										onChange={this.importStudentData}
										accept=".csv"
									/>
									...
									<div className="table-wrapper">
										<table>
											<thead>
												<tr>
													<th></th>
													{studentPreviewTableHeaders.map(header => (
