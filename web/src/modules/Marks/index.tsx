...
class Reports extends Component<propsType, S> {
	...
	getClassID = (section_id: string) => {
		...
		return Object.values(classes).find(c => (c.sections[section_id] ? true : false)).id
	}
				...
				<div className="reports-page no-print mt-5">
					<div className="form section exams-filter">
						...
						<div className="create-exam">
							<div className="button blue" onClick={() => this.createNewExam()}>
								Create New Exam
							</div>
							<div className="button grey create-exam" onClick={this.createBulkExams}>
								Create Bulk Exams
							</div>
						</div>
					</div>
					{exam_title && year && (
						<div className="section exams-list">
							<fieldset>
								...
								<div className="exams-table">
									<div className="mis-table-row table-header">
										...
										<div className="thead cell" style={{ width: '10%' }}>
											Edit/Delete
										</div>
									</div>
									{filtered_exams
...
export default connect(
	...
	(dispatch: Function) => ({
		deleteExam: (students: Array<string>, exam_id: string) =>
			dispatch(deleteExam(students, exam_id))
	})
)(Reports)
