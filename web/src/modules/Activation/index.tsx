						...
						{!stateProps.isVerified && (
							<div className="section">
								<div className="trial-alert">
									...
									<div className="trial-text is-danger">
										Trial has been ended. Please enter{' '}
										<strong>reset trial</strong> or <strong>purchase</strong>{' '}
										code to use MISchool
									</div>
								</div>
								<div className="activation-code">
									...
									<div className="row" style={{ marginTop: '0.375rem' }}>
										<div className="button blue" onClick={handleVerifyCode}>
											Verify Code
										</div>
									</div>
								</div>
