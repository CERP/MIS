		...
		<div className="print-only admission-form">
					...
					<div className="header-style">
						...
						{school.code && (
							<div className="school-code">
								{' '}
								School Code: {school.code || '_______'}{' '}
							</div>
						)}
					</div>
				</div>
			...
			<fieldset>
				...
				<div className="student-info-card">
					<div className="student-info">
						...
						<div className="row" style={{ marginBottom: '2.5mm' }}>
							...
							<div className="gender">
								<input type="checkbox" checked={student.Gender === 'male'} />
								<span>Male</span>
								<input type="checkbox" checked={student.Gender === 'female'} />
								<span>Female</span>
							</div>
						</div>
						<div className="row">
					...
					<div
						...
						style={{ border: avatar ? 'none' : '1px solid black' }}>
						{avatar && (
							<img
								src={avatar}
			...
			<fieldset style={{ marginTop: 5 }}>
				...
				<div className="row">
					...
					<div>
						{student.Phone || ''} {student.AlternatePhone || ''}
					</div>
				</div>
				<div className="row">
			...
			<fieldset style={{ marginTop: 5 }}>
				...
				<div className="row" style={{ marginTop: '5mm' }}>
					...
					<div>
						{student.StartDate ? moment(student.StartDate).format('DD, MMMM YYYY') : ''}
					</div>
				</div>
				<div className="row">
