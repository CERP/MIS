		...
		<>
			<div className="mis-alert modal-container inner">
				<div className="section-container">
					...
					<div
						className="row error"
						style={{ padding: 0, fontSize: '0.75rem', height: 12 }}>
						{props.error && <div>{props.error}</div>}
					</div>
					<div className="row actions">
						<button className="button grey cancel" onClick={props.onCancel}>
							Cancel
						</button>
						<button className="button blue" onClick={() => props.onSubmit(input)}>
							OK
						</button>
					</div>
				</div>
		...
		<>
			<div className="mis-alert">
				<div className="section-container">
					...
					<div className="row actions">
						<button className="button blue" onClick={props.onOK}>
							OK
						</button>
					</div>
				</div>
