...
export const ReachCard = ({ icon, title, reach }: ReachCardProps) => (
	<div className="flex flex-col items-center space-y-2">
		<img className="w-24 h-24 md:w-28 md:h-28 m-8 shadow-md rounded-full" src={icon} alt={title} />
...
export const FeatureCard = ({ icon, title, className }: React.DetailedHTMLProps<React.ImgHTMLAttributes<HTMLDivElement>, HTMLDivElement> & FeatureCardProps) => (
