			...
			{history.location.pathname !== '/landing' &&
				...
				history.location.pathname !== '/login' && (
					<div
						...
						style={{ backgroundImage: `url(${BackButtonIcon})` }}
					/>
				)}
			<div className="left">
...
export const PrintHeader = ({ settings, logo }: PropsType) => (
	<div className="print-only school-header">
		<div className="header-body">
			...
			<div className="header-style">
				<div className="title">
					{settings.schoolName ? settings.schoolName.toUpperCase() : ''}
				</div>
				<div className="address" style={{ marginBottom: '4px' }}>
					{settings.schoolAddress}
				</div>
				<div className="phone-number">Tel:{settings.schoolPhoneNumber}</div>

				{settings.schoolCode && settings.schoolCode !== '' && (
...
export const PrintHeaderSmall = ({ settings, logo }: PropsType) => (
	<div className="print-only small-school-header">
		<div className="row" style={{ alignItems: 'center' }}>
			<div style={{ width: '10%' }}>
				<img src={logo} alt="logo" width={32} height={32} />
			</div>
			<div style={{ width: '90%' }} className="small-title">
...
const SpecialLayoutWrap = (WrappedComponent: any) => ({ user, ...props }: PropsType) => (
	<div className="layout">
...
export const LayoutWrap = (WrappedComponent: any) =>
	connect((state: RootReducerState) => ({
		user: state.db.faculty[state.auth.faculty_id],
