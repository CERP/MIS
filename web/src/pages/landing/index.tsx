				...
				<div className="mt-20 px-20">
					...
					<div className="grid grid-cols-1 md:grid-cols-5 gap-6 mt-10">
						<div className="h-36 w-36 rounded-full bg-orange-brand mb-4 mx-auto">
							<img className="w-20 h-20 m-8 shadow-md rounded-full" src="favicon.ico" alt="a1" />
						</div>

						<div className="h-36 w-36 rounded-full bg-teal-500 mb-4 mx-auto">
							<img className="w-20 h-20 m-8 shadow-md rounded-full" src="favicon.ico" alt="a2" />
						</div>
						<div className="h-36 w-36 rounded-full bg-red-brand mb-4 mx-auto">
							<img className="w-20 h-20 m-8 shadow-md rounded-full" src="favicon.ico" alt="a3" />
						</div>
						<div className="h-36 w-36 rounded-full bg-teal-500 mb-4 mx-auto">
							<img className="w-20 h-20 m-8 shadow-md rounded-full" src="favicon.ico" alt="a4" />
						</div>
						<div className="h-36 w-36 rounded-full bg-orange-brand mb-4 mx-auto">
							<img className="w-20 h-20 m-8 shadow-md rounded-full" src="favicon.ico" alt="a5" />
						</div>
					</div>
				</div>
				...
				<div className="mt-20 px-20">
					...
					<div className="mt-10">
						<div className="grid md:gap-12 grid-cols-1 md:grid-cols-5 mx-auto space-y-4 md:space-y-0">
							<FeatureCard icon={iconPlug} title="Offline + Online" className="bg-yellow-300" />
							<FeatureCard icon={iconDesktop} title="Responsive" className="bg-blue-300" />
							<FeatureCard icon={iconCloud} title="Cloud Backup" className="bg-gray-300" />
							<FeatureCard icon={iconCall} title="Excellent Service" className="bg-blue-300" />
							<FeatureCard icon={iconCoin} title="Best Price" className="bg-yellow-300" />
						</div>
					</div>
				</div>
