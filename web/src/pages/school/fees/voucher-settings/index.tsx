					...
					<form
						...
						<div className="space-y-1">
							...
							<input
								...
								onChange={e =>
									handleInputByPath(['bankInfo', 'accountTitle'], e.target.value)
								}
								type="text"
							...
							<input
								...
								onChange={e =>
									handleInputByPath(['bankInfo', 'accountNo'], e.target.value)
								}
								type="text"
