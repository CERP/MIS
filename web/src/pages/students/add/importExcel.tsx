...
export const ImportStudentsCSV = () => {
	...
	const handleUploadCSV = useCallback((event: React.ChangeEvent<HTMLInputElement>) => {
		...
		reader.onloadend = () => {
			...
			setState({ ...state, isUploadingCSV: false, importedStudents: importedStudents, uploadedFileName: file.name })
		}
			...
			<div className="p-5 md:p-10 md:pb-0 text-gray-700 relative print:hidden space-y-8">
				...
				<div className="space-y-4 pb-2">
						...
						<div className="flex flex-row items-center space-x-4 text-white p-5">
							<div className="flex flex-col space-y-4 w-full">
								...
								<select
									name="classId"
									value={state.classId}
									onChange={(e) => setState({ ...state, sectionId: '', classId: e.target.value })}
					...
					<button
						...
						type="button" className={clsx("inline-flex w-full tw-btn text-white bg-blue-300", {
						...
						<label className="w-full mx-auto">
							<input
								...
								type="file" className="hidden" accept=".csv" />
