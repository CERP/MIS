...
export const SingleFamilyPayments = ({ match }: SingleFamilyPaymentsProps) => {
	// TODO: change to family ID
	// TODO: remove logic arround single student
	// TODO: create cards for pending ammount
	// TODO: generate payments for family

	const dispatch = useDispatch()

	const {
		auth,
		db: { students, settings, sms_templates, classes }
	} = useSelector((state: RootReducerState) => state)
	const { id: famId } = match.params
	const student = {} as MISStudent
	...
	const getSiblings = (stds: RootDBState['students']): AugmentedStudent[] => {
