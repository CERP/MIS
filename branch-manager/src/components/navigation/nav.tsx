	...
	return (
		<nav className="flex items-center justify-between flex-wrap bg-white py-4 md:px-12 border-b border-red-500">
			...
			<div className={`${menu ? '' : 'hidden'} w-full flex-grow md:flex md:items-center md:w-auto md:px-3 px-8`}>
				...
				<div className="flex ">
					<Link to="/login" className=" block text-md pl-2 md:pr-2  ml-2 py-1 text-red-500 font-bold md:mt-0 md:rounded md:border md:border-red-500 md:hover:bg-red-400 md:hover:text-white">Login</Link>
				</div>
			</div>
