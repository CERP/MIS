        ...
        <div className="flex h-screen md:flex">
            <div className="w-full md:w-1/2 bg-white flex items-center justify-center">
                <div className="max-w-sm m-8">
                    ...
                    <Link to="/" className="bg-transparent text-red-500 font-bold uppercase tracking-wide py-3 px-6 border-2 border-red-400 hover:border-red-500 rounded-lg">Go Home</Link>
                </div>
            </div>
        </div>
    )
